...
HD_PWD='C:/Users/bianc/Desktop/Facultate/An3/SSC/Laborator/Laborator 4/project_4.2/project_4.2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sumImplementation.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sumImplementation.tcl -notrace
