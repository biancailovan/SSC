...
HD_PWD='C:/Users/bianc/Desktop/Facultate/An3/SSC/Laborator/Laborator 4/project_4.2/project_4.2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sumImplementation.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sumImplementation.tcl
