...
HD_PWD='C:/Users/bianc/Desktop/Facultate/An3/SSC/Laborator/Laborator 4/project_4.6/project_4.6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log inmultireTest.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source inmultireTest.tcl -notrace
