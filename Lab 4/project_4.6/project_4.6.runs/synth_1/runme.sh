...
HD_PWD='C:/Users/bianc/Desktop/Facultate/An3/SSC/Laborator/Laborator 4/project_4.6/project_4.6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log inmultireTest.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source inmultireTest.tcl
