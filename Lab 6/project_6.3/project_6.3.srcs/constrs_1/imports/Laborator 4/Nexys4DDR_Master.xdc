...
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33} [get_ports Rdy]
#set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { Tx }]; #IO_L24P_T3_RS1_15 Sch=led[1]
