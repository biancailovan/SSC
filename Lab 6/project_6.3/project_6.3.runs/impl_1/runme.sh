...
HD_PWD='C:/Users/bianc/Desktop/Facultate/An 3/SSC/Laborator/Laborator 8/project_6.3/project_6.3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log modulPrincipal.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source modulPrincipal.tcl -notrace
