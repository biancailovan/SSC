...
HD_PWD='C:/Users/bianc/Desktop/project_7.2/project_7.2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log controler_SPI.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source controler_SPI.tcl
