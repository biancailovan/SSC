...
HD_PWD='C:/Users/bianc/Desktop/project_7.2/project_7.2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log controler_SPI.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source controler_SPI.tcl -notrace
