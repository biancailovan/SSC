...
HD_PWD='C:/Users/bianc/Desktop/Facultate/An 3/SSC/Laborator/Laborator 6/project_5.2/project_5.2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log inmultireBoothPlaca.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source inmultireBoothPlaca.tcl
