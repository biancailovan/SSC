...
HD_PWD='C:/Users/bianc/Desktop/Facultate/An 3/SSC/Laborator/Laborator 6/project_5.4/project_5.4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log inmultire.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source inmultire.tcl -notrace
