...
HD_PWD='C:/Users/bianc/Desktop/Facultate/An 3/SSC/Laborator/Laborator 10/project_7.2/project_7.2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log modul_principal_nexys.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source modul_principal_nexys.tcl -notrace
