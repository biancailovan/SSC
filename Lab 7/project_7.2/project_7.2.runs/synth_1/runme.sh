...
HD_PWD='C:/Users/bianc/Desktop/Facultate/An 3/SSC/Laborator/Laborator 10/project_7.2/project_7.2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log modul_principal_nexys.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source modul_principal_nexys.tcl
